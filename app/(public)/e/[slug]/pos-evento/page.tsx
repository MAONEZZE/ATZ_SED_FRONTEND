...
import { answerKeyForField, getPublicPostEventFields, submitPublicPostEvent } from "@/lib/api/public";
...
export default function PostEventPage() {
  ...
  async function onSubmit(values: Record<string, unknown>) {
    ...
    setSubmitting(true);
    try {
      await submitPublicPostEvent(slug, { identifier: trimmedId, answers });
      setDone(true);
    } catch (e) {
