...
import { useAllTemplates, useDeleteTemplateGlobal } from "@/lib/api/global-messaging";
...
/** Templates. Com `eventId`, lista só os do evento e some a coluna Evento. */
            ...
            : [
                {
                  key: "event",
                  header: "Evento",
                  cell: (t: TemplateWithEvent) => t.event?.title ?? "Global",
                },
              ]),
        ]}
        data={templates}
